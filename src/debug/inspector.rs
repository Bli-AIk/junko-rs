...
pub mod debug_inspector {
    ...
    pub(in crate::debug) struct InspectorUiState {
    ...
    #[derive(Component)]
    pub(in crate::debug) struct DebugHelpText {
        timer: Timer,
        visible: bool,
    ...
    pub(in crate::debug) fn setup_debug_features(app: &mut App) {
